...
public partial class Fixture : global::System.IDisposable {
  ...
  public Filter FilterData {
    ...
    get {
      global::System.IntPtr cPtr = Box2DPINVOKE.Fixture_FilterData_get(swigCPtr);
      Filter ret = (cPtr == global::System.IntPtr.Zero) ? null : new Filter(cPtr, true);
      return ret;
    } 
  }
  ...
  public Fixture Next {
    get {
      global::System.IntPtr cPtr = Box2DPINVOKE.Fixture_Next_get(swigCPtr);
