...
public class Box2D {
  ...
  public static b2Version b2_version {
    ...
    get {
      IntPtr cPtr = Box2DPINVOKE.b2_version_get();
      b2Version ret = (cPtr == IntPtr.Zero) ? null : new b2Version(cPtr, false);
      return ret;
    } 
  }
  ...
  public static b2Vec2 b2Vec2_zero {
    get {
      IntPtr cPtr = Box2DPINVOKE.b2Vec2_zero_get();
  ...
  public static void b2TimeOfImpact(b2TOIOutput output, b2TOIInput input) {
    Box2DPINVOKE.b2TimeOfImpact(b2TOIOutput.getCPtr(output), b2TOIInput.getCPtr(input));
  }
