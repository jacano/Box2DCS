...
public class b2World : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal b2World(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(b2World obj) {
  ...
  public void DrawDebugData() {
    Box2DPINVOKE.b2World_DrawDebugData(swigCPtr);
  }
  ...
  public b2Body GetBodyList() {
    IntPtr cPtr = Box2DPINVOKE.b2World_GetBodyList__SWIG_0(swigCPtr);
    b2Body ret = (cPtr == IntPtr.Zero) ? null : new b2Body(cPtr, false);
    return ret;
  }

  public b2Joint GetJointList() {
    IntPtr cPtr = Box2DPINVOKE.b2World_GetJointList__SWIG_0(swigCPtr);
    b2Joint ret = (cPtr == IntPtr.Zero) ? null : new b2Joint(cPtr, false);
    return ret;
  }

  public b2Contact GetContactList() {
    IntPtr cPtr = Box2DPINVOKE.b2World_GetContactList__SWIG_0(swigCPtr);
