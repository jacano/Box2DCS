...
public class b2Body : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal b2Body(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(b2Body obj) {
  ...
  public b2Fixture CreateFixture(b2FixtureDef def) {
    IntPtr cPtr = Box2DPINVOKE.b2Body_CreateFixture__SWIG_0(swigCPtr, b2FixtureDef.getCPtr(def));
  ...
  public b2Vec2 GetLinearVelocity() {
    b2Vec2 ret = new b2Vec2(Box2DPINVOKE.b2Body_GetLinearVelocity(swigCPtr), true);
    return ret;
  }
  ...
  public void ApplyTorque(float torque) {
    Box2DPINVOKE.b2Body_ApplyTorque(swigCPtr, torque);
  }
  ...
  public void ApplyAngularImpulse(float impulse) {
    Box2DPINVOKE.b2Body_ApplyAngularImpulse(swigCPtr, impulse);
  }
  ...
  public void SetActive(bool flag) {
    Box2DPINVOKE.b2Body_SetActive(swigCPtr, flag);
  }

  public bool IsActive() {
    bool ret = Box2DPINVOKE.b2Body_IsActive(swigCPtr);
    return ret;
  }
  ...
  public b2Fixture GetFixtureList() {
    IntPtr cPtr = Box2DPINVOKE.b2Body_GetFixtureList__SWIG_0(swigCPtr);
    b2Fixture ret = (cPtr == IntPtr.Zero) ? null : new b2Fixture(cPtr, false);
    return ret;
  }

  public b2JointEdge GetJointList() {
    IntPtr cPtr = Box2DPINVOKE.b2Body_GetJointList__SWIG_0(swigCPtr);
    b2JointEdge ret = (cPtr == IntPtr.Zero) ? null : new b2JointEdge(cPtr, false);
    return ret;
  }

  public b2ContactEdge GetContactList() {
    IntPtr cPtr = Box2DPINVOKE.b2Body_GetContactList__SWIG_0(swigCPtr);
    b2ContactEdge ret = (cPtr == IntPtr.Zero) ? null : new b2ContactEdge(cPtr, false);
    return ret;
  }

  public b2Body GetNext() {
    IntPtr cPtr = Box2DPINVOKE.b2Body_GetNext__SWIG_0(swigCPtr);
    b2Body ret = (cPtr == IntPtr.Zero) ? null : new b2Body(cPtr, false);
    return ret;
  }

  public SWIGTYPE_p_void GetUserData() {
    IntPtr cPtr = Box2DPINVOKE.b2Body_GetUserData(swigCPtr);
  ...
  public b2World GetWorld() {
    IntPtr cPtr = Box2DPINVOKE.b2Body_GetWorld__SWIG_0(swigCPtr);
    b2World ret = (cPtr == IntPtr.Zero) ? null : new b2World(cPtr, false);
    return ret;
  }
