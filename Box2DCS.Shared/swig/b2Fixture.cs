...
public class b2Fixture : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal b2Fixture(IntPtr cPtr, bool cMemoryOwn) {
  ...
  public b2Shape GetShape() {
    IntPtr cPtr = Box2DPINVOKE.b2Fixture_GetShape__SWIG_0(swigCPtr);
  ...
  public b2Body GetBody() {
    IntPtr cPtr = Box2DPINVOKE.b2Fixture_GetBody__SWIG_0(swigCPtr);
    b2Body ret = (cPtr == IntPtr.Zero) ? null : new b2Body(cPtr, false);
    return ret;
  }

  public b2Fixture GetNext() {
    IntPtr cPtr = Box2DPINVOKE.b2Fixture_GetNext__SWIG_0(swigCPtr);
    b2Fixture ret = (cPtr == IntPtr.Zero) ? null : new b2Fixture(cPtr, false);
    return ret;
  }

  public SWIGTYPE_p_void GetUserData() {
    IntPtr cPtr = Box2DPINVOKE.b2Fixture_GetUserData(swigCPtr);
