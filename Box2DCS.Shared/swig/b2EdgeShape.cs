...
public class b2EdgeShape : b2Shape {
  ...
  internal b2EdgeShape(IntPtr cPtr, bool cMemoryOwn) : base(Box2DPINVOKE.b2EdgeShape_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override b2Shape Clone(b2BlockAllocator allocator) {
    IntPtr cPtr = Box2DPINVOKE.b2EdgeShape_Clone(swigCPtr, b2BlockAllocator.getCPtr(allocator));
  ...
  public b2Vec2 m_vertex1 {
    ...
    get {
      IntPtr cPtr = Box2DPINVOKE.b2EdgeShape_m_vertex1_get(swigCPtr);
  ...
  public b2Vec2 m_vertex2 {
    ...
    get {
      IntPtr cPtr = Box2DPINVOKE.b2EdgeShape_m_vertex2_get(swigCPtr);
      b2Vec2 ret = (cPtr == IntPtr.Zero) ? null : new b2Vec2(cPtr, false);
      return ret;
    } 
  }
  ...
  public b2Vec2 m_vertex0 {
    ...
    get {
      IntPtr cPtr = Box2DPINVOKE.b2EdgeShape_m_vertex0_get(swigCPtr);
      b2Vec2 ret = (cPtr == IntPtr.Zero) ? null : new b2Vec2(cPtr, false);
      return ret;
    } 
  }
  ...
  public b2Vec2 m_vertex3 {
    ...
    get {
      IntPtr cPtr = Box2DPINVOKE.b2EdgeShape_m_vertex3_get(swigCPtr);
      b2Vec2 ret = (cPtr == IntPtr.Zero) ? null : new b2Vec2(cPtr, false);
      return ret;
    } 
  }
